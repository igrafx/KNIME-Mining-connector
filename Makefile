...
build:
	...
	call conda activate && call conda activate knime-ext-bundling && build_python_extension.bat .\igrafx_extension\igrafx_knime_extension .\igrafx_extension\releases\$(VERSION) && conda deactivate
else
# macOS commands
install-builder:
